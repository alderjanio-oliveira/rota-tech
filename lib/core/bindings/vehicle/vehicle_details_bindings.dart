...
class VehicleDetailsBindings implements Bindings {
  @override
  void dependencies() {
    Get.lazyPut<MapCustomController>(() => MapCustomController(Get.find<TraccarService>(), Get.find<TraccarWebSocketService>()));
    Get.lazyPut<VehicleDetailsController>(
      () => VehicleDetailsController(traccarService: Get.find<TraccarService>(), deviceId: Get.arguments),
